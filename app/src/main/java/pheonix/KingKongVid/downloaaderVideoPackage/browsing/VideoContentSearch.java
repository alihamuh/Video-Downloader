...
public abstract class VideoContentSearch extends Thread {
    ...
    public abstract void onVideoFound(String size, String type, String link, String name,
                                      String page, boolean chunked, String website,String thumbnail);

    public VideoContentSearch(Context context, String url, String page, String title,String thumbnail) {
    ...
    private void addVideoToList(URLConnection uCon, String page, String title, String contentType) {
        try {
            ...
            switch (contentType) {
              ...
              //get{"https://api.dailymotion.com/video/{@id}?fields=thumbnail_large_url"};

                thumbnail=url;

                onVideoFound(size, type, link, name, page, chunked, website,thumbnail);////
        ...
        try {
            ...
            if (host.contains("twitter.com") || host.contains("metacafe.com") || host.contains
                ...
                if (host.contains("twitter.com")) {
                    ...
                    type = "ts";
                         thumbnail=url;
                    onVideoFound(null, type, link, name, page, true, website,thumbnail);
                    String videoFound = "name:" + name + "\n" +
                            "link:" + link + "\n" +
                            "type:" + contentType + "\n" +
                            "size: null";
