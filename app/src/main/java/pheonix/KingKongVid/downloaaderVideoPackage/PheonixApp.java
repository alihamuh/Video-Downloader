...
public class PheonixApp extends Application {
    private static PheonixApp instance;
    private Intent downloadService;
    private PheonixActivity.OnBackPressedListener onBackPressedListener;
    ...
    public static PheonixApp getInstance() {
        return instance;
    }

    public PheonixActivity.OnBackPressedListener getOnBackPressedListener() {
