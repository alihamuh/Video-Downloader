...
public class Downloads extends PheonixFragment implements PheonixActivity.OnBackPressedListener, Tracking, DownloadsInProgress.OnNumDownloadsInProgressChangeListener, DownloadsCompleted.OnNumDownloadsCompletedChangeListener, DownloadsInactive.OnNumDownloadsInactiveChangeListener {
    private View view;
...
*/
            ...
            if(search.getVisibility() ==View.VISIBLE) {
                ...
                getLMvdActivity().getSupportActionBar().setTitle("Downloads");
            }
