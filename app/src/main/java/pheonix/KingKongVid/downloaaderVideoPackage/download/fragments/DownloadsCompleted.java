...
import pheonix.KingKongVid.downloaaderVideoPackage.download.lists.CompletedVideos;
...
public class DownloadsCompleted extends PheonixFragment implements DownloadsInProgress.OnAddDownloadedVideoToCompletedListener {
    private View view;
    ...
    public void onResume() {
        ...
        completedVideos.save(PheonixApp.getInstance().getApplicationContext());
        onNumDownloadsCompletedChangeListener.onNumDownloadsCompletedChange();
    }
    ...
    private class VideoItem extends RecyclerView.ViewHolder implements ViewTreeObserver.OnGlobalLayoutListener {
        ...
        VideoItem(View itemView) {
            ...
            thumb =itemView.findViewById(R.id.video_thumbnail_completed);
            ...
            play.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Uri fileUri = FileProvider.getUriForFile(getActivity(), "alihamuh.fastvideo" +
                            ".videodownloader.fileprovider", file);
