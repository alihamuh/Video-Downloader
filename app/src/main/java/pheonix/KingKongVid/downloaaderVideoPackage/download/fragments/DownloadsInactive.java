...
import pheonix.KingKongVid.downloaaderVideoPackage.download.lists.InactiveDownloads;
...
public class DownloadsInactive extends PheonixFragment implements DownloadsInProgress.OnAddDownloadItemToInactiveListener {
    private View view;
        ...
        public void updateLink(final String link) {
            ...
            getActivity().runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    download.thumbnail =item.thumbnail;
                    downloads.remove(position);
                    inactiveDownloads.save(getActivity());
                    downloadsList.getAdapter().notifyItemRemoved(position);
                    onNumDownloadsInactiveChangeListener.onNumDownloadsInactiveChange();
