...
import pheonix.KingKongVid.downloaaderVideoPackage.download.fragments.DownloadsInProgress;
...
public class DownloadRearranger implements View.OnTouchListener {
    ...
    public DownloadRearranger(Context context, DownloadsInProgress downloadsInProgress) {
        ...
        thumb = anchorView.findViewById(R.id.video_thumbnail);
        task =new DataBaseTask(anchorView);
    ...
    public void start(DownloadsInProgress.DownloadItem itemHolder, DownloadVideo item) {
        ...
        //DataBaseTask task =new DataBaseTask();
         ...
         //task.execute(item.thumbnail);
             //thumb.setImageBitmap(task.doInBackground(item.thumbnail));
